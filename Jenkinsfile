pipeline {
  ...
  stages {
      ...
      stage('logging into AWS ECR') {
              ...
              steps {  
                script{
                    sh """aws sts get-caller-identity --region ${AWS_DEFAULT_REGION} | docker login --username AWS --password-stdin ${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_DEFAULT_REGION}.amazonaws.com"""
                }
              }
      }
